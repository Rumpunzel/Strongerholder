...
const ConditionUsage := preload("res://addons/state_machine/new_inspector/condition_usage.gd")
const ConditionUsageScene := preload("res://addons/state_machine/new_inspector/condition_usage.tscn")

const _MENU_BUTTON_NAME := "MenuButton"

var transition_item_resource: TransitionItem setget set_transition_item_resource
...
func _update_style() -> void:
	...
	for from_state in transition_item_resource.from_states:
		from_state_names.append(from_state)
	if has_to_state:
		to_state_name = transition_item_resource.to_state
...
func set_transition_item_resource(new_transition_item_resource: TransitionItem) -> void:
